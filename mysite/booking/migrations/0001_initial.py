    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_types', models.CharField(choices=[('1P', 'Cameră pentru 1 persoană'), ('2P', 'Cameră pentru 2 persoane'), ('3P', 'Cameră pentru 3 persoane'), ('APT', 'Apartament')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_type', models.CharField(choices=[('single', 'Single'), ('double', 'Double'), ('triple', 'Triple'), ('apartment', 'Apartment')], max_length=20)),
